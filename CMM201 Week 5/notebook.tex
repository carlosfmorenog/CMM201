...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} The main menu from last week (my version, feel free to use your own!)}
...
Exiting the program
    ...
    \hypertarget{main-menu-with-functions}{%
\subsection{Main menu with functions}\label{main-menu-with-functions}}

    The first thing you will do is set three cells for functions
\emph{option1}, \emph{option2} and \emph{option3}:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{option1}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}This function corresponds to option 1 (a list of the first ten multiples of a number).\PYZsq{}\PYZsq{}\PYZsq{}}
            \PY{n}{multiples} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The multiples are:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{k}{for} \PY{n}{a} \PY{o+ow}{in} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{a}\PY{o}{*}\PY{n+nb}{int}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
                \PY{n}{multiples}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{a}\PY{o}{*}\PY{n+nb}{int}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
            \PY{k}{return} \PY{n}{multiples}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{option2}\PY{p}{(}\PY{n}{name}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}This function corresponds to option 2 (library/beach).\PYZsq{}\PYZsq{}\PYZsq{}}
            \PY{n}{ans} \PY{o}{=} \PY{k+kc}{True}
            \PY{k}{while} \PY{n}{ans}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Is it raining?}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{y} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{accumulate}\PY{p}{(}\PY{n}{numbers}\PY{p}{,} \PY{n}{acc}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}This function corresponds to the accumulator.\PYZsq{}\PYZsq{}\PYZsq{}}
...
\end{Verbatim}
    ...
    Then, we need to modify the main menu from last week and see how we can
migrate the contents from each option to its respective function.
Consider the following: 1. Remember that the accumulator function uses a
list as its first input. How can we input a list into python? Can we use
the \emph{input()} function? 2. The second input of the
\emph{accumulate()} function is \emph{acc}, which is the value of the
accumulator. If option 3 is executed the first time, then the value of
\emph{acc} should start as 0, but if it is run a second time, then the
function has to use the existing \emph{acc} value!

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} The new main menu, now with four options}
        
        \PY{n}{acc} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{x} \PY{o}{=} \PY{k+kc}{True}
        \PY{k}{while} \PY{n}{x}\PY{p}{:}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Welcome to my menu. Select an option (1,2,3,4):}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{x} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
            \PY{k}{if} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Insert a number:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{n} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
                \PY{n}{multiples} \PY{o}{=} \PY{n}{option1}\PY{p}{(}\PY{n}{n}\PY{p}{)}
            \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Enter your name:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{name} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
                \PY{n}{option2}\PY{p}{(}\PY{n}{name}\PY{p}{)}
            \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Enter a list to accumulate:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{numbers} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                \PY{n}{m} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{input}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Enter number of elements : }\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
                \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{m}\PY{p}{)}\PY{p}{:} 
                    \PY{n}{ele} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{input}\PY{p}{(}\PY{p}{)}\PY{p}{)}   
                    \PY{n}{numbers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{ele}\PY{p}{)}
                \PY{n}{acc} \PY{o}{=} \PY{n}{accumulate}\PY{p}{(}\PY{n}{numbers}\PY{p}{,} \PY{n}{acc}\PY{p}{)}
            \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Exiting the program}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n}{x} \PY{o}{=} \PY{k+kc}{False}
            \PY{k}{else}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wrong option. Please try again.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
is selected first!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} The new main menu, now linking the output of option 1 to option 3}
         
         \PY{n}{acc} \PY{o}{=} \PY{l+m+mi}{0}
         \PY{n}{options} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{x} \PY{o}{=} \PY{k+kc}{True}
         \PY{k}{while} \PY{n}{x}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Welcome to my menu. Select an option (1,2,3,4):}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{x} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
             \PY{n}{options}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x}\PY{p}{)}
             \PY{k}{if} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Insert a number:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{n} \PY{o}{=} \PY{n+nb}{input}\PY{p}{(}\PY{p}{)}
                 \PY{n}{multiples} \PY{o}{=} \PY{n}{option1}\PY{p}{(}\PY{n}{n}\PY{p}{)}
             \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{2}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 ...
                 \PY{n}{option2}\PY{p}{(}\PY{n}{name}\PY{p}{)}
             \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{k}{if} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{1}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{in} \PY{n}{options}\PY{p}{:}
                     \PY{n}{acc} \PY{o}{=} \PY{n}{accumulate}\PY{p}{(}\PY{n}{multiples}\PY{p}{,} \PY{n}{acc}\PY{p}{)}
                 \PY{k}{else}\PY{p}{:}
                     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Select option 1 first.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{k}{elif} \PY{n}{x} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Exiting the program}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{x} \PY{o}{=} \PY{k+kc}{False}
             \PY{k}{else}\PY{p}{:}
